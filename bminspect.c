...
static Relation
_bm_get_relation_by_name(text *name)
{
	Relation	rel;
	RangeVar   *relrv;
...
static void
values_to_string(StringInfo s, TupleDesc tupdesc, Datum *values, bool *nulls)
{
	int			natt;
